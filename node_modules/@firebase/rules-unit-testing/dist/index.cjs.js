 ...
 */
var firestore = firebase__default['default'].firestore, database = firebase__default['default'].database; firebase__default['default'].storage;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, requestPromise(request__namespace.get, {
                            method: 'GET',
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, requestPromise(request__namespace.put, {
                            method: 'PUT',
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, requestPromise(request__namespace.delete, {
                            method: 'DELETE',
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    result = _a.sent();
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, requestPromise(request__namespace.put, {
                        method: 'PUT',
